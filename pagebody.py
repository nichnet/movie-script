...
class PageBody(QFrame):
    ...
    def initUI(self):
        ...
        HEADER_HEIGHT = convert_inches_to_pixels(page_margin_rule.get("top"))
       
        MARGIN_LEFT = convert_inches_to_pixels(page_margin_rule.get("left"))
        MARGIN_RIGHT = convert_inches_to_pixels(page_margin_rule.get("right"))
